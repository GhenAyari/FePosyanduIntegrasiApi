  ...
  return (
    <div className="card">
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
        <div className="bidang-icon-tile" style={{ background: 'var(--cyan-bg)', color: 'var(--cyan-deep)', width: '52px', height: '52px' }}><svg className="ic ic-lg"><use href="#i-phone" /></svg></div>
