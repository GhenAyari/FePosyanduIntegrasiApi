...
export default function ProfilView() {
  ...
  // === FUNGSI SAKTI CETAK PDF ===
  const handlePrint = (section) => {
    setPrintSection(section);
    // Beri jeda agar React me-render tabel rahasia, lalu buka jendela print
    setTimeout(() => {
      window.print();
      // Kembalikan state setelah jendela print ditutup
      setTimeout(() => setPrintSection(null), 1000);
    }, 150);
  };
    ...
    <>
      ...
      <style>{`
        ...
        @media print {
          ...
          .tabel-cetak th { background-color: #f2f2f2; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; width: 40%; }
